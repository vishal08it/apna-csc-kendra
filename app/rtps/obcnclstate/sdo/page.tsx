...
export default function SDOApplicationForm() {
  const [applicationType, setApplicationType] =
    useState<"normal" | "tatkal">("normal");

  const [roCertificatePdf, setRoCertificatePdf] = useState<string | null>(null);
  ...
  return (
    <section className="min-h-screen bg-gray-900 text-white px-4 py-10">
      ...
      <form className="max-w-4xl mx-auto space-y-10">
        ...
        {/* RO CERTIFICATE DETAILS */}
        <section className="space-y-5">
          <h2 className="section-title">
            RO Certificate Details / आरओ प्रमाण-पत्र विवरण
          </h2>
          ...
          <UploadBox
            label="Upload RO Level Certificate (PDF Only) / आरओ प्रमाण-पत्र अपलोड *"
            accept="application/pdf"
            file={roCertificatePdf}
            setFile={setRoCertificatePdf}
          />
        </section>
