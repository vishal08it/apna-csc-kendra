...
export default function OBCNCLSDOApplicationForm() {
  const [applicationType, setApplicationType] =
    useState<"normal" | "tatkal">("normal");

  const [roCertPdf, setroCertPdf] = useState<string | null>(null);
    ...
    <section className="min-h-screen bg-gray-900 text-white px-4 py-10">
      ...
      <div className="max-w-4xl mx-auto mb-8 text-center">
        ...
        <p className="text-green-400 font-semibold mt-1">
          (अन्य पिछड़ा वर्ग – नॉन क्रीमी लेयर | SDO स्तर)
        </p>
      </div>
      ...
      <form className="max-w-4xl mx-auto space-y-10">
        ...
        <section className="space-y-6">
          <h2 className="section-title">
            RO Certificate Details / RO प्रमाण-पत्र विवरण
          </h2>

          <Input
            label="Certificate No. (Issued from RO Level) / एसडीओ प्रमाण-पत्र संख्या *"
            required
          />

          <UploadField
            label="Upload RO Level Certificate (PDF Only) / RO प्रमाण-पत्र अपलोड *"
            preview={roCertPdf}
            onChange={setroCertPdf}
